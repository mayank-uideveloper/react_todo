    ...
    return (
        <ContainerCard headingData="Welcome to Portal">
            {!authData.isRegister && registerUserAlert &&
                <div className="alert alert-info" role="alert">Oops! Seems like you never registered to our portal please click on Register Now and then try to login again.</div>
            }
